...
public class CreateRequest extends StringRequest {
    private static final String REGISTER_REQUEST_URL = "http://poll.16mb.com/create_poll.php";
    private Map<String, String> params;

    public CreateRequest(String question, String choice1, String choice2, String choice3,String choice4,int id,String date,Response.Listener<String> listener) {
